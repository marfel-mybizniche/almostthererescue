...
<main id="template_body" class="home_template">
    ...
    <section class="hero hero-s6">
		...
		<figure class="bg">
			<video autoplay loop muted playsinline>
				<source src="http://www.atfcaz.org/wp-content/uploads/2015/03/puppy-bowl-2015-4.webmhd.webm" type="video/webm">
				<source src="http://www.atfcaz.org/wp-content/uploads/2015/03/puppy-bowl-2015-4.mp4" type="video/mp4">
			</video>
		</figure>
            ...
            <div class="grid-container"> 
                <div class="grid-x grid-margin-x">
                    <div class="cell large-9 align-self-middle">
                        <h1>Specializing in saving the lives of </h1>
            ...
            <div class="grid-x grid-margin-x">
                <div class="cell large-8 large-offset-2">
                    <div class="cta-body">
                        ...
                        <p><strong>Ready to take your heart for a spin?</strong> Just head over to our <strong>petfinder</strong> page to see all of our adorable pups looking for furever homes. Almost There Rescue has a pretty constant flow of puppies and adult dogs of all kinds who are guaranteed to take your breath away.</p>

                        <p class="button-a">
							<!-- <a href="http://almostthererescue.petfinder.com/" target="_blank" class="xbutton xpurple with_icon">
                                <img class="invert-0" src="<?php echo MBN_ASSETS_URI ?>/img/icons/petfinder.png" alt="Petfinder" /> 
                                <span>View Adoptable Dogs on Petfinder</span>
                            </a> -->
							<a href="http://almostthererescue.petfinder.com/" target="_blank">View Adoptable Dogs on Petfinder</a>
                        </p>
                        ...
                        <div class="keep_in_touch">
                            <p>
                                ...
                                <a href="https://www.facebook.com/almostthererescue" target="_blank">
                                    <img src="<?php echo MBN_ASSETS_URI ?>/img/logo-text-facebook.png" alt="Facebook" /></a> 
                                <a href="https://www.instagram.com/almostthererescue/" target="_blank">
                                    <img src="<?php echo MBN_ASSETS_URI ?>/img/logo-text-instagram.png" alt="Instagram" /></a>
    ...
    <section class="page_section service_options">
        <div class="grid-container">
            <div class="grid-x align-center">
                <div class="cell service_cell small-6 medium-2 large-2">
                    <div class="service_box_wrapper">
                        <a href="<?php the_permalink(222); ?>">
                            <svg xmlns="http://www.w3.org/2000/svg" width="62.531" height="62.544"><defs></defs><g id="donate_icon" transform="translate(-.054)"><g id="Group_834" transform="translate(.054 36.891)"><g id="Group_833"><path id="Path_1364" d="M5.8 302H1.886a1.831 1.831 0 00-1.832 1.832v21.988a1.831 1.831 0 001.832 1.832H5.8a5.5 5.5 0 005.5-5.5V307.5a5.5 5.5 0 00-5.5-5.5z" class="cls-1" transform="translate(-.054 -302)"/></g></g><g id="Group_836" transform="translate(14.957 36.189)"><g id="Group_835"><path id="Path_1365" d="M169.147 300.5a3.355 3.355 0 00-.843-.916 3.631 3.631 0 00-4.947.367l-8.319 9.6-.257.293a5.407 5.407 0 01-4.031 1.759h-14.218a1.832 1.832 0 110-3.665h11.177a3.675 3.675 0 003.665-3.665v-.037a3.668 3.668 0 00-3.665-3.628h-6.633a5.044 5.044 0 01-3.225-1.209 12.843 12.843 0 00-15.795-.843V321.1a42.3 42.3 0 0011.141 1.5h16.345a12.844 12.844 0 0010.261-5.131l8.8-11.727a4.853 4.853 0 00.544-5.242z" class="cls-1" transform="translate(-122.056 -296.246)"/></g></g><g id="Group_838" transform="translate(12.148)"><g id="Group_837"><path id="Path_1366" d="M136.093 3.542a10.438 10.438 0 00-16.56 1.164c-.165.231-.32.462-.464.69-.145-.229-.3-.459-.464-.69a10.438 10.438 0 00-16.56-1.164 12.216 12.216 0 00-2.991 8.158c0 3.362 1.3 6.465 4.106 9.765a88.673 88.673 0 0010.009 9.264c1.5 1.266 3.051 2.575 4.7 4a1.832 1.832 0 002.4 0c1.648-1.428 3.2-2.738 4.7-4 2.607-2.2 4.859-4.1 6.812-5.944 3.793-3.579 7.3-7.641 7.3-13.085a12.216 12.216 0 00-2.988-8.158z" class="cls-1" transform="translate(-99.054)"/></g></g></g></svg>
                             <span>Donate</span></a>
                    </div>
                </div>
                <div class="cell service_cell small-6 medium-2 large-2">
    ...
    <div class="page_section map_section">
        <div class="grid-container full">
            <div class="grid-x">
                <div class="cell large-6 text_content">
                    <h2>Visiting & Adopting</h2>
    ...
    <div class="page_section sign_up_section">
        <div class="grid-container full">
            <div class="grid-x align-right">
                ...
                <div class="cell medium-12 large-7 text_content">
                    ...
                    <p>We’d love to keep in touch! Follow us on Facebook, Instagram, or sign up for our mailing list to receive updates, view upcoming adoptable pups, and get a glimpse of behind the scenes action! <br> <small>(We promise we won’t hound you)</small></p>
                   
                    <p>
                        <a href="https://visitor.r20.constantcontact.com/d.jsp?llr=s4zzvz8ab&p=oi&m=1129364383730&sit=nfskxt5lb&f=712a7eff-7e76-437d-a073-393c8084151b" target="_blank" class="button with_icon no_invert green">
                            <img src="<?php echo MBN_ASSETS_URI ?>/img/icons/email_list_icon.svg" alt="Join Our Mailing List" /> 
                            <img src="<?php echo MBN_ASSETS_URI ?>/img/icons/email_list_icon_black.svg" alt="Join Our Mailing List" class="hovered_img" /> 
    ...
    <div class="page_section amazon_section">
        <div class="grid-container">
            <div class="grid-x">
                <div class="cell large-12 amazon_wishlist">
                    <div class="grid-x align-center">
    ...
    <div class="page_section ig_feed">
        <div class="grid-container">
            <div class="grid-x ig_title">
                <div class="cell large-12">
                    <h2><a href="https://www.instagram.com/almostthererescue/" target="_blank">@almostthererescue</a></h2>
                </div>
            </div>
            <div class="grid-x">
                <div class="cell large-12">
